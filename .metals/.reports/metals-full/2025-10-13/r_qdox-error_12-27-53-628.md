error id: file://<WORKSPACE>/granary-backend/src/main/java/com/example/granary_backend/infrastructure/web/mpesa/exception/MpesaProcessingException.java
file://<WORKSPACE>/granary-backend/src/main/java/com/example/granary_backend/infrastructure/web/mpesa/exception/MpesaProcessingException.java
...
```java
offset: 0
uri: file://<WORKSPACE>/granary-backend/src/main/java/com/example/granary_backend/infrastructure/web/mpesa/exception/MpesaProcessingException.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/granary-backend/src/main/java/com/example/granary_backend/infrastructure/web/mpesa/exception/MpesaProcessingException.java